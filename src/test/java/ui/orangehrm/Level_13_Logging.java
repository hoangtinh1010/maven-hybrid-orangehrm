...
//        log.info("NewEmployee_01 - Step 01: Enter to 'Username' ang 'Password' with info: " + adminUsername + " | " + adminPassword);
        loginPage.enterToUsernameTextbox(adminUsername);
        loginPage.enterToPasswordTextbox(adminPassword);

//        log.info("NewEmployee_01 - Step 02: Click to 'Login' button and navigate to 'Dashboard' page");
        dashboardPage = loginPage.clickToLoginButton();
        verifyTrue(dashboardPage.isLoadingSpinnerDisappear(driver));
        dashboardPage.sleepInSecond(2);

//        log.info("NewEmployee_01 - Step 03: Navigate to 'Dashboard' page");
        employeeListPage = dashboardPage.clickToPIMMenu();
        verifyTrue(employeeListPage.isLoadingSpinnerDisappear(driver));
        employeeListPage.sleepInSecond(2);

//        log.info("NewEmployee_01 - Step 04: Click to 'Add Employee' button and open 'Add Employee' page");
        addEmployeePage = employeeListPage.clickToAddEmployeeButton();
        verifyTrue(addEmployeePage.isLoadingSpinnerDisappear(driver));

//        log.info("NewEmployee_01 - Step 05: Enter to 'First Name' and 'Last Name' textbox with data: " + employeeFirstName + " | " + employeeLastName);
        addEmployeePage.enterToFirstNameTextbox(employeeFirstName);
        addEmployeePage.enterToLastNameTextbox(employeeLastName);
        employeeID = addEmployeePage.getEmployeeIDValue();

//        log.info("NewEmployee_01 - Step 06: Click to 'Save' button and navigate to 'Personal Detail' page");
        personalDetailPage = addEmployeePage.clickToSaveButton();
        verifyTrue(personalDetailPage.isLoadingSpinnerDisappear(driver));
        personalDetailPage.sleepInSecond(4);

//        log.info("NewEmployee_01 - Step 07: Verify  Employee is displayed: " + employeeFirstName);
        verifyEquals(personalDetailPage.getFirstNameTextBoxValue(), employeeLastName);

//        log.info("NewEmployee_01 - Step 08: Verify Last Name is displayed: " + employeeLastName);
        verifyEquals(personalDetailPage.getLastNameTextBoxValue(), employeeFirstName);

//        log.info("NewEmployee_01 - Step 09: Verify Employee ID is displayed: " + employeeID);
